...
<body>
    ...
    <script>
        ...
        const APP_PASSWORD_HASH = 'c03c1a054bd18b924e3d7134b2b0b7ce8b6d0e94a49893e1ae3af7c1cba2168c'; // SHA-256 Hash
        ...
        try {
            events = JSON.parse(loadEventsFromWordPress()) || [];
        } catch(e) {
